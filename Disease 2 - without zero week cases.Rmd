...
library(tidyverse)
library(ggplot2)
combined_dataset_disease2<-read.csv("https://raw.githubusercontent.com/maliat-hossain/FileProcessing/main/combined_dataset_disease2.csv")
```
...
combined_dataset_disease2 <- combined_dataset_disease2 %>%
  filter(Cryptosporidiosis_Cases_Count> 0)
...
dataset_prophet2 <- combined_dataset_disease2 %>%
  select(Date, Cryptosporidiosis_Cases_Count) %>%
  rename(ds = Date, y = Cryptosporidiosis_Cases_Count)
